...
#[inline]
pub fn vfs_err_to_kernel<T>(res: Result<T, crate::vfs::inode::VfsError>) -> KernelResult<T> {
    res.map_err(|e| match e {
        crate::vfs::inode::VfsError::NotFound => KernelError::NotFound,
        crate::vfs::inode::VfsError::PermissionDenied => KernelError::PermissionDenied,
        crate::vfs::inode::VfsError::Exists => KernelError::Exists,
        crate::vfs::inode::VfsError::NotEmpty => KernelError::NotEmpty,
        crate::vfs::inode::VfsError::IsDirectory => KernelError::IsDirectory,
        crate::vfs::inode::VfsError::NotADirectory => KernelError::NotADirectory,
        crate::vfs::inode::VfsError::FileTooLarge => KernelError::FileTooLarge,
        crate::vfs::inode::VfsError::NoSpaceLeft => KernelError::NoSpaceLeft,
        crate::vfs::inode::VfsError::InvalidFilename => KernelError::InvalidFilename,
        crate::vfs::inode::VfsError::InvalidSeek => KernelError::InvalidSeek,
        crate::vfs::inode::VfsError::OperationNotSupported => KernelError::OperationNotSupported,
        crate::vfs::inode::VfsError::IoError => KernelError::IoError,
        crate::vfs::inode::VfsError::Busy => KernelError::Busy,
    })
}
