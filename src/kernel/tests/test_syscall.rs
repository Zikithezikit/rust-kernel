...
use crate::ipc::syscall::handler::{get_ticks, increment_ticks, SYSCALL_TABLE};
use crate::ipc::syscall::numbers::{
    Errno, FileDescriptor, SyscallNumber, SyscallResult, NR_SYSCALLS,
};
